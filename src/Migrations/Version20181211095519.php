 ...
 */
final class Version20181211095519 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE user_id (id INT NOT NULL, city_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, surname VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, phone INT NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, birthday TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, sex VARCHAR(25) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE salon (id INT NOT NULL, name VARCHAR(255) NOT NULL, phone INT NOT NULL, gps_address VARCHAR(255) DEFAULT NULL, email VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
